<%@ Page Title="" Language="C#" MasterPageFile="~/admin/LayOut1.Master" AutoEventWireup="true" CodeBehind="SuaSanPham.aspx.cs" Inherits="JustShop.admin.Views.sanpham.SuaSanPham" %>
                    ...
                    <div class="mb-4">
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtHanSuDung" CssClass="form-control" TextMode="date"></asp:TextBox>
                               <asp:Label runat="server" ID="Label2" CssClass="text-danger"></asp:Label>
                            </div>
                            <div class="form-group">
                                <label for="">Hình ảnh cho sản phẩm:</label> 
                                <br />
                              <asp:Image runat="server" id="anhsp" style="width:250px"/>
                                <br />
                                <br />
                               <asp:FileUpload ID="image" runat="server" CssClass="form-control-file" aria-describedby="fileHelpId" />
                               
                            </div>
                            <asp:Button runat="server" ID="btnSua"  CssClass="btn btn-primary" Text="Cập nhật sản phẩm" OnClick="btnSua_Click"/>
                            <br />
