...
{
    public partial class sanphamChon : System.Web.UI.Page
    {
        string id = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            id = Request.QueryString["MaLoai"].ToString();
            if(!IsPostBack)
            {
        ...
        {
            rpSanPham.DataSource = new Dao_JustShop.sanphamModel().getsanpham(id);
            rpSanPham.DataBind();
        }
