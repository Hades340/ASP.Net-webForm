<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Layout_2.Master" AutoEventWireup="true" CodeBehind="sanphamChon.aspx.cs" Inherits="JustShop.Client.Views.SanPham.sanphamChon" %>
                    ...
                    <asp:Repeater runat="server" ID="rpSanPham">
                         <ItemTemplate>
                            ...
                            <div class="card-body bd" style="margin-top:-20px">
                                ...
                                <asp:Button runat="server" ID="Button1" OnClick="Button1_Click" OnCommand="Button1_Command" CommandArgument='<%# Eval("MaSp") %>' CssClass="add adds" Text="Thêm vào giỏ" />
