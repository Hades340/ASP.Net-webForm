...
function draw() {
    ...
    for (let i = 0; i < name.length; i++) {
        ...
        <tr>
        <td scope="row">
            <img class="anhsp" src="${name[i].anh}" alt="">
        </td>
        <td>
            <p class="tensp">${name[i].name}</p>
        </td>
        <td>
            <input class="soluong" type="number" name="" id="" value="${name[i].soluong}" onchange="changeNumber(this,${name[i].id})  ">
        </td>
        <td>
            <p class="Giass">${name[i].gia}</p>
        </td>
        <td>
            <p class="thanhtien">${name[i].soluong * name[i].gia}</p>
